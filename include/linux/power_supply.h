...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_HV_PREPARE_MAINS,	/* Prepare Adaptive Charger */
	POWER_SUPPLY_TYPE_HV_ERR,		/* Adaptive Charger Err */
	POWER_SUPPLY_TYPE_HV_UNKNOWN,		/* Adaptive Charger Unknown */
	POWER_SUPPLY_TYPE_HV_MAINS,		/* Adaptive Charger */
	POWER_SUPPLY_TYPE_MDOCK_TA,		/* MMdock charger */
